      ...
      <div class="normal-player" v-show="fullScreen">
          ...
          <scroll class="middle-r" ref="lyricList" :data="currentLyric && currentLyric.lines">
            <div class="lyric-wrapper">
              <div v-if="currentLyric">
                <p class="text" :class="{'current': currentLyricNum === index}" v-for="(line, index) in currentLyric.lines" ref="lyricLine">{{line.txt}}</p>
              </div>
            </div>
          </scroll>
        </div>
        <div class="bottom">
          ...
          <div class="operators">
            ...
            <div class="icon icon-left" :class="disable">
              <i class="icon-prev" @click="prev"></i>
            </div>
            <div class="icon icon-center" :class="disable">
...
export default {
  ...
  methods: {
    ...
    handleLyric({lineNum, txt}) {
      ...
      if (lineNum > 5) {
        let lyricLineEl = this.$refs.lyricLine[lineNum - 5]
        this.$refs.lyricList.scrollToElement(lyricLineEl, 1000)
      } else {
